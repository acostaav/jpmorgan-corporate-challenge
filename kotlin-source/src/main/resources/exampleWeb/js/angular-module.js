...
app.controller('ModalInstanceCtrl', function ($http, $location, $uibModalInstance, $uibModal, demoApp, apiBaseURL, peers, challenges, years) {
    ...
    modalInstance.create = () => {
        if (invalidFormInput()) {
            ...
            const createResultEndpoint = `${apiBaseURL}add-result?partyName=${modalInstance.form.counterparty}&challengeName=${modalInstance.form.challengeName}&challengeYear=${modalInstance.form.challengeYear}&plc=${modalInstance.form.plc}&gpic=${modalInstance.form.gpic}&bib=${modalInstance.form.bib}&name=${modalInstance.form.name}&time=${modalInstance.form.time}&gender=${modalInstance.form.gender}`;
