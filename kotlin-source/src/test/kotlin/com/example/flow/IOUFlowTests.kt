...
//        network.runNetwork()
//
//        // The ResultContract specifies that IOUs cannot have negative values.
...
//
//            val recordedState = txOutputs[0].data as ResultState
...
//        for (node in listOf(a, b)) {
//            node.transaction {
//                val ious = node.services.vaultService.queryBy<ResultState>().states
